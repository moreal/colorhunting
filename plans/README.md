...
| 6     | [App Integration](./06-app-integration.md)                              | Done   | Start here if the pages exist but are not wired into one persistent user flow.    | Connect persistent Colorhunting flow            |
| 7     | [Review and Quality Gates](./07-review-and-quality-gates.md)            | Done   | Start here after the implementation pass is complete or reviewer feedback exists. | Apply review feedback and final quality checks  |
