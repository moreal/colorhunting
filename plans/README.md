...
| 2     | [Domain State and Persistent Storage](./02-domain-state-and-storage.md) | Not started | Start here if `AppState` and IndexedDB storage APIs do not exist.                 | Add persistent app state model                  |
